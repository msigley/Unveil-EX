...
this.getAttribute("data-fake-height")&&(b.height("auto"),this.removeAttribute("data-fake-height"));(d||c)&&"function"===typeof f&&f.call(this);!1!==a.unveilPrintEventsLeft&&setTimeout(function(){a.unveilPrintEventsLeft--;1>a.unveilPrintEventsLeft&&(a.unveilPrintText&&a.unveilPrintText.remove(),a.unveilPrintEventsCallPrintAfter&&(a.unveilPrintEventsCallPrintAfter=!1,window.print()))},1E3)});if(a.unveilMutationObserver){var u=function(b){var d;for(d=0;d<b.length;d++){var c=b[d];console.log(c);a.unveilIsVisible(c.target)&&
a(c.target).trigger("unveil")}};c.each(function(){this.unveilAttributeObserver||(this.unveilAttributeObserver=a.unveilMutationObserver=new MutationObserver(u),this.unveilAttributeObserver.observe(this,{attributes:!0}))})}var g=a.unveilCallIndex,l=function(){clearTimeout(a.unveilEventTimers[g]);var b=c.filter(function(){var b=a(this);if(!a.unveilIsVisible(this))return!a.unveilMutationObserver;var c=h.scrollTop(),e=c+h.height(),f=b.offset().top;return f+b.height()>=c-m&&f<=e+m}).trigger("unveil");c=
c.not(b);c=c.filter(function(){return a.unveilInDOM(this)});c=c.filter(function(){return a.unveilHasEvent(this)});c.length||h.off(".unveil"+g)};a.unveilCallStack.push(l);var n=function(){var b=a("img").not(".no-lazy-load img").filter(function(){return a.unveilHasEvent(this)});b.length?(a.unveilPrintEventsLeft=b.length,a.unveilPrintText&&a.unveilPrintText.show(),b.trigger("unveil")):a.unveilPrintText&&a.unveilPrintText.remove()};h.on("scroll.unveil"+g+" resize.unveil"+g,function(){clearTimeout(a.unveilEventTimers[g]);
a.unveilEventTimers[g]=setTimeout(l,20)});l();if("onbeforeprint"in window){var p=function(){window.removeEventListener("beforeprint",p);n()};window.addEventListener("beforeprint",p)}else if(window.matchMedia){var q=window.matchMedia("print"),r=function(a){a.matches&&(q.removeListener(r),n())};q.addListener(r)}a.unveilCallIndex++;return this}})(window.jQuery||window.Zepto);
